...
export default function EndGuideComponent({id, restartGuide}) {
    ...
    return (
        <div className="flex flex-col justify-evenly items-center text-lg bg-[#55BDB3DD] p-6 py-8 lg:w-[60%] w-[80%] m-auto rounded h-[50vh]">
            <div>
            ...
            <div className="flex flex-col gap-4 justify-center items-center gap-4 mt-6 ">
                <div className="flex lg:flex-row flex-col gap-4 m-auto">
                    <BackButton 

...
export default function FeatureSection() {
    ...
    return (
        <div className="bg-custom-gray w-full flex p-24 pr-16 gap-10">
            ...
            <div  className="w-[45%] items-end relative">
                <img src={borderEllipse} alt="border design element" className=" w-[50%] absolute rotating-border top-[-30%] left-[-5%]" />
